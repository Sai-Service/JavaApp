...
//    }
    ...
    //jasper conn for washing report
...
//       return new ByteArrayInputStream(byteArray.toByteArray());
    ...
    //jasper conn for goa washing report
    public byte[] getVehWashMainReportGa(Map<String, Object> parameters, String fileNme) throws Exception {
